...
- `apps/analysis/_outputs/v3/overview/` for cross-experiment summary tables and heatmaps
- `apps/analysis/_outputs/v3/experiments/<experiment_tag>/` for single-experiment drilldowns
- `apps/analysis/_outputs/v3/families/<family_slug>/` for family-level matched comparisons

By default it also writes an investigation pass under `apps/analysis/_outputs/v3/investigation/` containing:
...
The default local rubric embedder is `BAAI/bge-small-en-v1.5`, cached under `apps/analysis/_cache/`.
